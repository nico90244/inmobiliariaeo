        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-3 mt-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button onClick={handleSaveEdit} disabled={saving} className="flex-1 py-2.5 bg-primary text-primary-foreground font-heading text-sm font-semibold tracking-widest uppercase hover:bg-primary/90 transition-colors disabled:opacity-50 flex items-center justify-center gap-2">
